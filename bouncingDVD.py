...
NOTE: Do note resize the terminal window while this program is running.
...
try:
    ...
    print('This program requires the bext modgule, which you')
...
def main():
    ...
    while True: # Main program loop.
        for logo in logos: # Handle each logo in the logos list.
            # Eras the logo's current location:
            ...
            # Se if the logo bounces off the top edge:
